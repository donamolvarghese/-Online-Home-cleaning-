...
<header>
  <div class="container_12">
    <div class="grid_12">
        <h1>
        <a href="index.html">
          <img src="logo.jpg" alt="Your Happy Family">
        </a>
      </h1>
  ...
  <div class="grid_12">
    <div class="slider_wrapper ">
       <div class="camera_wrap" id="camera_wrap">
            <div data-thumb="home-cleaning-tips.jpg" data-src="home-cleaning-tips.jpg">
                <div class="caption fadeFromBottom">
                    Clever interior projects for your home
                </div>
            </div>
            <div data-thumb="519582436.jpg" data-src="519582436.jpg">
                <div class="caption fadeFromBottom">
                    Home improvement ideas for you
                </div>
            </div>
            <div data-thumb="444.jpg" data-src="444.jpg">
                <div class="caption fadeFromBottom">
                    Premium design tips
                </div>
            </div>
            <div data-thumb="images/thumb3.png" data-src="images/slide3.jpg">
                <div class="caption fadeFromBottom">
                  Only creative ideas about cleaning
                </div>
            </div>
        </div>
    </div>
...
<div class="page1_block">
  <div class="container_12">
    <div class="grid_12">
      <div class="center">
        <h2>Welcome!</h2>
        Our company offers you the best home cleaning services
        <div class="alright">
    ...
    <div class="grid_12 center">
      ...
      <section class="tt-grid-wrapper">
        <ul class="tt-grid tt-effect-stackback tt-effect-delay">
          ...
          <li><a href="#"><img src="house.jpg" alt=""></a></li>
          <li><a href="#"><img src="home-cleaning-tips.jpg" alt=""></a></li>
          <li><a href="#"><img src="House-Cleaning.jpg" alt=""></a></li>
          <li><a href="#"><img src="images1.jpg" alt="img04"></a></li>
